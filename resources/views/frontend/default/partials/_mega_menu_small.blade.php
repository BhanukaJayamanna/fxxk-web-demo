                        ...
                        <a target="{{$item->is_newtab == 1?'_blank':''}}" href="{{route('frontend.category-product',['slug' => @$item->category->slug, 'item' =>'category'])}}" class="menu_product">
                            <div class="single_mega_menu_product">
                              <div class="media align-items-center">
                                <div class="media_img">
                                  <img data-src="{{asset(asset_path(@$item->category->categoryImage->image?@$item->category->categoryImage->image:'frontend//default/img/default_category.png'))}}" src="{{showImage(themeDefaultImg())}}" class="align-self-center lazyload" alt="{{@$item->category->name}}"/>
                                </div>
