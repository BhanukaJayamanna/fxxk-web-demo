...
"email" => "Email",
"envato_email" => "Fxxk Account Email",
...
"verify" => "Verify",
"welcome" => "Welcome",
"welcome_description" => "Please follow the steps to complete FxxK installation!",
