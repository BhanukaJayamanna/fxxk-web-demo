...
<form action="{{ route('company_information_update') }}" method="POST" enctype="multipart/form-data">
    ...
    <div class="General_system_wrap_area">
        <div class="single_system_wrap">
            ...
            <div class="single_system_wrap_inner text-center">
                <div class="logo">
                    <span>{{ __('general_settings.lazyload_image') }}<small>(250px X 250px)</small></span>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-xl-6">
                    <div class="primary_input mb-25">
                        ...
                        <input class="primary_input_field" placeholder="-" type="text" id="pwa_app_name" name="pwa_app_name" value="{{env('PWA_NAME','Fxxk')}}" required>
                    </div>
                </div>
